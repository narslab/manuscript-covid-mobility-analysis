...
Similar studies aggregate data on a daily basis and use a dynamic spatial network model to estimate the confirmed infections in each country from a global sample. \trbcite{zhang2020covid19} Passenger flight capacity is used as opposed to the actual number of passengers who flew in the studied time frame (January to April, 2020). Aggregated location data is also used in the mobility networks models explaining inequities but focusing solely on the US. 
